...
import craft2 from '../../Assets/on1.Webp';
    ...
    <section className="hero-section">
      ...
      <div className={`hero-content container ${isVisible ? 'visible' : ''}`}>
        ...
        <div className="hero-buttons">
          <Button variant="secondary" href="/contact">Get a Free Quote</Button>
          <Button variant="outline-primary" href="/projects">View Our Projects</Button>
        </div>
